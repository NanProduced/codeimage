...
export const locale = {
  it: {
    ...
    canvas: {
      ...
      switchedToTerminalMode: 'Passato alla modalità terminale',
    },
    editor: {
      mode: 'Modalità',
      codeMode: 'Codice',
  ...
  en: {
    canvas: {
      ...
      switchedToTerminalMode: 'Switched to terminal mode',
    },
    editor: {
      mode: 'Mode',
      codeMode: 'Code',
      terminalMode: 'Terminal',
      ansiTheme: 'ANSI Theme',
      prompt: 'Prompt',
      username: 'Username',
      hostname: 'Hostname',
      directory: 'Directory',
  ...
  de: {
    ...
    canvas: {
      ...
      pastedCode: 'Code has been pasted',
      errorFormattedCode: 'Invalid code while formatting',
      switchedToTerminalMode: 'In Terminal-Modus gewechselt',
    },
    editor: {
      mode: 'Modus',
      codeMode: 'Code',
      terminalMode: 'Terminal',
      ansiTheme: 'ANSI-Design',
      prompt: 'Eingabeaufforderung',
      username: 'Benutzername',
      hostname: 'Hostname',
      directory: 'Verzeichnis',
      showPrompt: 'Eingabeaufforderung anzeigen',
      promptStyle: 'Eingabestil',
      cursor: 'Cursor',
  ...
  es: {
    ...
    canvas: {
      ...
      pastedCode: 'Code has been pasted',
      errorFormattedCode: 'Invalid code while formatting',
      switchedToTerminalMode: 'Cambiado al modo terminal',
    },
    editor: {
      mode: 'Modo',
      codeMode: 'Código',
  ...
  zh: {
    ...
    canvas: {
      ...
      pastedCode: '代码已粘贴',
      errorFormattedCode: '格式化代码时无效',
      switchedToTerminalMode: '已切换到终端模式',
    },
    editor: {
      mode: '模式',
      codeMode: '代码',
    ...
    readOnlyBanner: {
      title: '您正在以只读模式查看编辑器。克隆代码片段以保存到工作区并编辑。',
    },
    locales: {
      it: '意大利语',
      en: '英语',
    ...
    export: {
      ...
      noOpacitySupportedWithThisExtension: '自定义透明度与此扩展不兼容',
      quality: '质量',
    },
    shortcut: {
      esc: 'Esc',
      ...
      toggleHeader: '显示/隐藏标题',
      toggleWatermark: '显示/隐藏水印',
      selectLanguage: '选择语言',
      changePadding: '更改内边距',
