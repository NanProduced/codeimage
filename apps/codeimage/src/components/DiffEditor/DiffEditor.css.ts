...
export const line = style({
  ...
  fontFamily: themeVars.fontFamily.mono,
  whiteSpace: 'pre',
  position: 'relative',
...
export const diffInput = style({
  ...
  borderRadius: themeVars.borderRadius.md,
  color: themeVars.textColor.primary,
  fontFamily: themeVars.fontFamily.mono,
  fontSize: themeVars.fontSize.sm,
  resize: 'vertical',
  outline: 'none',
